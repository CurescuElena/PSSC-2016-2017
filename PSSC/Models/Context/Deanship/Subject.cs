...
namespace Models.Context.Deanship
{
    ...
    {
        public Common.Subject.SubjectInformation SubjectInfo { get; internal set; }

        private Dictionary<Common.Student.Student, Models.Context.Deanship.SubjectSituation> _signedUpStudentsGrades;
